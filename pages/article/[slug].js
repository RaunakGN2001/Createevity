  ...
  return (
    <>
        ...
        <Box paddingLeft='15px' borderLeft='4px solid gray' background='linear-gradient(90deg, rgba(227,227,227,1) 10%, rgba(255,255,255,1) 100%)' display='flex' paddingTop='0.5rem' paddingBottom='0.5rem' marginTop='1rem' alignItems='center' gap='10px'>
            <Image height='45px' width='48px' borderRadius='50%' src={`${deployedBackendLink}${article.attributes.author.data.attributes.avatar.data.attributes.formats.thumbnail.url}`} />
        ...
        <Box marginTop='4rem'>
            <Image className='articleImage' width='100%' src={`${deployedBackendLink}${article.attributes.Image.data.attributes.formats.large.url}`} marginBottom='25px' />
